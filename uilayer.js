Move.require.define("UILayer/UILayer","UILayer/UILayer.mv",function(require,module,exports){
  ...
  UILayer.textureBackedProperties = {
    matrix: {
      get: function () {
        return this._matrix || (this._matrix = new CSSMatrix(this.element_.style.webkitTransform));
      },
      set: function () {
        var values;
